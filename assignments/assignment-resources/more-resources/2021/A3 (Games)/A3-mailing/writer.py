...
test_to_types["test_make_init_state"] = test_types[0]
test_to_types["test_make_init_board"] = test_types[0]

test_to_types["test_successors_simple"] = test_types[1]
test_to_types["test_successors_through_goal"] = test_types[1]
