...
def compute_utility(board, color): #this should end up being BETTER
...
def minimax_min_node(board, color, limit, caching = 0):
    ...
    # If there are no moves left or we are at limit, return the utility
    ...
    for each in all_moves:
        ...
        if caching and (next_board, opponent) in cache:             
            move, new_utility = cache[(next_board,opponent)]

        else:
            # If the new utility is less than the current min, update min_utiltiy
            move, new_utility = minimax_max_node(next_board, color, limit, caching = 0)
            if caching: cache[(next_board,opponent)] = (move, new_utility)
...
def minimax_max_node(board, color, limit, caching = 0): #returns highest possible utility
    ...
    for each in all_moves:
        ...
        if caching and (next_board,color) in cache: move, new_utility = cache[(next_board,color)]
            ...
            move, new_utility = minimax_min_node(next_board, color, limit, caching = 0)
...
def alphabeta_min_node(board, color, alpha, beta, limit, caching = 0, ordering = 0):
    ...
    for each in all_moves_sorted:
        ...
        if caching and (next_board,opponent,alpha,beta) in cache: move, new_utility = cache[(next_board,opponent,alpha,beta)]
            ...
            move, new_utility = alphabeta_max_node(each[1], color, alpha, beta, limit, caching, ordering)
...
def alphabeta_max_node(board, color, alpha, beta, limit, caching = 0, ordering = 0):
    ...
    if ordering: all_moves_sorted.sort(key = lambda util: compute_utility(util[1], color), reverse=True)
    ...
    for each in all_moves_sorted:
        ...
        if caching and (next_board, color) in cache: move, new_utility = cache[(next_board,color)]        
            ...
            # If the new utility is greater than the current max, update max_utility
            move, new_utility = alphabeta_min_node(each[1], color, alpha, beta, limit, caching, ordering)
            if caching: cache[(next_board, color)] = (move, new_utility)
