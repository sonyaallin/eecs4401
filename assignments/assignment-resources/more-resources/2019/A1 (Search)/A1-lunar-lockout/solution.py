...
from lunarlockout import LunarLockoutState, Direction, lockout_goal_state #for LunarLockout specific classes
...
if __name__ == "__main__":
  ...
  #TEST CODE
  solved = 0; unsolved = []; counter = 0; percent = 0; timebound = 0.05; #1 second time limit for each problem
  print("*************************************")  
