...
subject = "CSC384 Assignment 3"    #email subject
me = "csc384ta@cs.toronto.edu" #not sure if this works this semester

template = open("templateA3.txt")
...
def generate_message(row):
    ...
    results = "students/%s/A3/_results.txt" % row[0]
    ...
    formatted = formatted.replace("{}", results, 1)
...
def mail(to):
    ...
    for row in data:
        ...
        if to == "test" and nmails >= 0:            
            ...
            #print(stud_mes)
            nmails = nmails - 1
            if (destination == "kammulaa@teach.cs.toronto.edu"):  
