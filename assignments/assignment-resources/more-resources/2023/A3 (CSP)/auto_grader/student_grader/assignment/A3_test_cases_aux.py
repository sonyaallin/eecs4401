from dependencies.BayesianNetwork import *
from dependencies.MedicalBayesianNetwork import *
...
from utils.utilities import setTO, TO_exc
...
class RestrictionTest:
    ...
    def test(self, StudentVariableElimination):
        ...
        try:
            ...
            setTO(timeout)
            result = StudentVariableElimination.restrict_factor(self.factor, self.variable, self.value)
            setTO(0)
...
class SummationTest:
    ...
    def test(self, StudentVariableElimination):
        ...
        try:
            ...
            setTO(timeout)
            result = StudentVariableElimination.sum_out_variable(self.factor, self.variable)
            setTO(0)
            result2 = reorder_factor_scope(result, self.answer[0])
...
class VETest:
    ...
    def test(self,StudentVariableElimination):
        ...
        try:
            ...
            for i in self.evidence:
                i[0].set_evidence(i[1])            
            result = StudentVariableElimination.VariableElimination(self.net, self.queryVariable, self.evidenceVars)                 
            setTO(0)
...
class MedTest:
    ...
    def test(self, StudentDecisionSupport):
        ...
        try:            
            ...
            setTO(timeout)
            result = StudentDecisionSupport.DecisionSupport(self.mednet,self.patient)
            setTO(0)
...
AlarmNet2 = BayesianNetwork("Home Alarm", [Burglary2, Earthquake2, Alarm2, John2, Mary2], [F10D, F11D, F12D, F13D, F14D, F17D])
...
t4 = RestrictionTest(F9, V3, 'Cold', [['Colour','Distance',],[0.3, 0, 0.1, 0.05]], "Factor Restriction Test 4")
t5 = RestrictionTest(F15, V4, 'Yes', [[],[0.7]], "Factor Restriction Test (Constant Factor Result)")
...
t6 = SummationTest(F6,Cancer,[['Tuberculosis or Lung Cancer','Tuberculosis',],[2.0, 1.0, 0, 1]], "Factor Sum Out Test 1")
t7 = SummationTest(F9,V1,[['Distance','Temperature',],[0.4, 0.2, 0.05, 0.25]], "Factor Sum Out Test 2")
t8 = SummationTest(F9,V2,[['Colour','Temperature',],[0.3, 0.25, 0.15000000000000002, 0.2]], "Factor Sum Out Test 3")
#t9 = SummationTest(F9,V3,[['Colour','Distance',],[0.35, 0.2, 0.25, 0.1]], 4, "Factor Sum Out Test 4")
#    #Test: Constant factor result, sum out
#t10 = SummationTest(F16,V5,[[],[1.43]], 3, "Factor Sum Out Test (Constant Factor Result)")    

t9 = SummationTest(F9,V3,[['Colour','Distance',],[0.35, 0.2, 0.25, 0.1]], "Factor Sum Out Test 4")
    #Test: Constant factor result, sum out
t10 = SummationTest(F16,V5,[[],[1.43]], "Factor Sum Out Test (Constant Factor Result)")    

    

    
t16= VETest(Asia,[[Smoking,'smoker'], [Dyspnea,'present'], [Xray,'abnormal']],Cancer,[[0.7237140153108922, 0.27628598468910776]], "Variable Elimination Test 1")

#This test is to make sure no input factors were altered!
t17= VETest(Asia,[[Smoking,'smoker'], [Dyspnea,'present'], [Xray,'abnormal']],Cancer,[[0.7237140153108922, 0.27628598468910776]], "Variable Elimination Alteration Test (Repeat of 1)")

t18 = VETest(Asia,[[VisitAsia,'visit'], [TBorCA,'true'], [Xray,'abnormal']],Cancer,[[0.5378973105134475, 0.4621026894865526]], "Variable Elimination Test 2")
t19 = VETest(AlarmNet,[[John, True], [Mary, False]],Earthquake,[[0.0045386400007529125, 0.9954613599992471]], "Variable Elimination Test 3")
t20 = VETest(AlarmNet,[[John, False], [Mary, False], [Earthquake, True]],Alarm,[[0.012901897594550255, 0.9870981024054498]], "Variable Elimination Test 4")
t21 = VETest(AlarmNet,[[Burglary, False], [Mary, True], [Earthquake, False]],John,[[0.10565949485500468, 0.8943405051449953]], "Variable Elimination Test 5")
t22 = VETest(AlarmNet2,[[John2, True], [Mary2, False]],Earthquake2,[[0.0045386400007529125, 0.9954613599992471]], "Variable Elimination (Constant Factor Input)")
...
#@max_grade(2)
#def restriction_test_1():        
#    return t1.test()
#
#@max_grade(2)
#def restriction_test_2():        
#    return t2.test()
#
#@max_grade(2)
#def restriction_test_3():        
#    return t3.test()
#
#@max_grade(2)
#def restriction_test_4():        
#    return t4.test()
#
#@max_grade(2)
#def restriction_test_5():        
#    return t5.test()
#
#
#@max_grade(2)
#def summation_test_1():        
#    return t6.test()
#
#@max_grade(2)
#def summation_test_2():        
#    return t7.test()
#
#@max_grade(2)
#def summation_test_3():        
#    return t8.test()
#
#@max_grade(2)
#def summation_test_4():        
#    return t9.test()
#
#@max_grade(2)
#def summation_test_5():        
#    return t10.test()
#
#
#@max_grade(3)
...
#@max_grade(4)
#def VE_test_9():        
#    return AG2_test.test()
#
#@max_grade(4)
#def VE_test_10():        
#    return AG3_test.test()
#
#
#
#
#@max_grade(5)
#def Q2_test_1():        
#    return  medtest1.test()    
#
#@max_grade(5)
#def Q2_test_2():        
#    return  medtest2.test()    
#
#@max_grade(5)
#def Q2_test_3():        
#    return  medtest3.test()    
#
#@max_grade(5)
#def Q2_test_4():        
#    return  medtest4.test()    
#
#@max_grade(5)
#def Q2_test_5():        
#    return  medtest5.test()    
#
