...
os.environ['SDL_VIDEODRIVER'] = 'dummy' #Not sure why this is here
...
#PROBLEM TEST (worth 20)
def problem_test_1(stu_solution):

    details = set()
    score = 0
    myBN = stu_solution.NaiveBayesModel()
    sol = [100, 0.0, 57, 66, 8.1, 25.4]

    # Q1 What percentage of the women in the test data set end up with a P(S=">=$50K"|E1) that is strictly greater than P(S=">=$50K"|E2)?
    # Q2 What percentage of the men in the test data set end up with a P(S=">=$50K"|E1) that is strictly greater than P(S=">=$50K"|E2)?
    # Q3 What percentage of the women in the test data set with P(S=">=$50K"|E1) > 0.5 actually have a salary over $50K?
    # Q4 What percentage of the men in the test data set with P(S=">=$50K"|E1) > 0.5 actually have a salary over $50K?
    # Q5 What percentage of the women in the test data set are assigned a P(Salary=">=$50K"|E1) > 0.5, overall?
    # Q6 What percentage of the men in the test data set are assigned a P(Salary=">=$50K"|E1) > 0.5, overall?
    
    # Note that some students interpreted Q3 and Q4 to be asking for the number of men/women in the test data set with P(S=">=$50K"|E1) > 0.5 and a salary higher $50K, over the total number of men/women.
    # If you interpret that way, you get sol = [100, 0.0, 4.6, 16.9, 8.1, 25.4]
    # Either way predictions appears biased against women
...
def main():
    score, Details = minfill_test_1()  # max is  3
    print("Score is: {}\nDetails: {}".format(score, Details))
    score, Details = minfill_test_2()  # max is  4
    print("Score is: {}\nDetails: {}".format(score, Details))
    score, Details = nb_test_1()  # max is  10
    print("Score is: {}\nDetails: {}".format(score, Details))
    score, Details = nb_test_2()  # max is  10
    print("Score is: {}\nDetails: {}".format(score, Details))
    score, Details = problem_test_1()  # max is 20
    print("Score is: {}\nDetails: {}".format(score, Details))
...
if __name__ == '__main__':
    ...
    try:
        module1_name = "submissions." + student + ".A4.solution"
    ...
    if FOUND_SOLUTION is False:
        filename = "results/" + student + "_results.txt"
        f = open(filename, "w")
    ...
    test_case_weight = {
        nb_test_1: 10,  # worth 10%
        nb_test_2: 10,  # worth 10%
        problem_test_1: 20,  # worth 20%
        minfill_test_1: 3,  # worth 3%
        minfill_test_2: 4  # worth 4%
    }
