...
def test_tagging(test_file):
	...
	solution_file = "/Users/JaglalLab/Desktop/CSC384/csc384-a3/ta/data/private/"+test_file+'.soln'
...
if __name__ == '__main__':
	...
	solutions = np.load('/Users/JaglalLab/Desktop/CSC384/csc384-a3/ta/soln/soln-private-1.npz')
	...
	#with np.errstate(divide='raise'):
		#try:
	#prior, transition, emission = train_HMM('/Users/JaglalLab/Desktop/CSC384/csc384-a3/ta/data/private/train-private-1')
	...
	with np.errstate(divide='raise'):
		try:
			prior_2, transition_2, emission_2 = train_HMM('/Users/JaglalLab/Desktop/CSC384/csc384-a3/ta/data/private/train-private-1')
		except TimeOutException as ex:
			g.write("TimeOutException when training. {}\n".format(ex))
		except Exception as e:
			g.write("Exception when training. {}\n".format(e))
