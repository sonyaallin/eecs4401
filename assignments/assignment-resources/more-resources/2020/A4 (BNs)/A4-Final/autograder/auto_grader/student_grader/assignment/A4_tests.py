...
def norm_test_2(student_modules):
    ...
    if norm_sum == 1:
      ...
      details.add("failed.")
    details.add('{} when normalized to {} sum to {}'.format([i for i in range(0,-5,-1)], normalized_nums, norm_sum))
...
def norm_test_3(student_modules):
    ...
    details.add("Normalization test 3 ....")
    ...
    if norm_sum == 0:
      ...
      details.add("failed.")
    details.add('{} when normalized to {} sum to {}'.format([i for i in range(4,-5,-1)], normalized_nums, norm_sum))
...
@max_grade(8)
def old_VE_tests(student_modules):
    ...
    details.add("old_VE_tests: ".format(score))
    details = "\n".join(details)    
    return score, details

@max_grade(3)
def old_multiply_factors_tests(student_modules):
    ...
    details.add("old_multiply_factors_tests: ".format(score))
    details = "\n".join(details)    
    return score, details

@max_grade(2)
def old_sum_out_variable_tests(student_modules):
    ...
    details.add("old_sum_out_variable_tests: ".format(score))
    details = "\n".join(details)    
    return score, details

@max_grade(3)
def old_restrict_factor_tests(student_modules):
    ...
    details.add("old_restrict_factor_tests: ".format(score))
    details = "\n".join(details)    
    return score, details    
