...
# CONSTANTS
DEFAULT_ASSIGNMENT_NUM = 4 # Assignment wanting to grade (default if not specified)
...
FILENAME_TEST_CASES = "A4_tests.py"
...
import assignment.A4_tests as test_cases_module
