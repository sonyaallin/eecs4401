...
Grandma = Variable('Grandma', ['to', 'from'])
F1 = Factor("F1", [Grandma])
F1.add_values([['to', 0.5], ['from', 0.5]])

Colour = Variable('Colour', ['red', 'blue', 'orange'])
F2 = Factor("F2", [Colour])
F2.add_values([['red', 0.5], ['blue', 0.3], ['orange', 0.2]])

Highway = Variable('Highway', ['exit', 'stay'])
F3 = Factor("F3", [Highway, Colour])
F3.add_values([['exit', 'red', 0.1],
               ['exit', 'blue', 0.1],
               ['exit', 'orange', 0.25],
               ['stay', 'red', 0.9],
               ['stay', 'blue', 0.9],
...
Type = Variable('Type', ['car', 'truck'])
F4 = Factor("F4", [Type, Colour, Grandma])
F4.add_values([['car', 'red', 'to', 0.9],
              ['car', 'blue', 'to', 0.0],
              ['car', 'orange', 'to', 0.8],
              ['car', 'red', 'from', 1.0],               
              ['car', 'blue', 'from', 0.1],               
              ...
              ['truck', 'blue', 'from', 0.9],
              ['truck', 'orange', 'to', 0.2],
              ['truck', 'orange', 'from', 0.2]])

Quiz = BN('Quiz', [Grandma, Colour, Highway, Type], [F1, F2, F3, F4])
...
if __name__ == '__main__':
    ...
    Grandma.set_evidence('to')
    Type.set_evidence('car')
    probs = VE(Quiz, Highway, [Grandma, Type])
    print(probs)   
