...
for index, row in responses.iterrows():
    ...
    try:
        ...
        probs1 = VE(medical, v3, [v2, v1])
        probs2 = VE(medical, v3, [v1])
        diffs = [abs(probs1[i]-probs2[i]) < 0.001 for i in range(len(probs1))]
        if teach_cs_id == "fongkwan":
            print(v1)
            print(v2)
            print(v3)     
            print(diffs)
    ...
    try:
        ...
        probs_v1_v3_v4_v2 = VE(medical, v1, [v3, v4, v2])
        probs_v1_v3_v4 = VE(medical, v1, [v3, v4])
        probs_v1_v3_v4_v5 = VE(medical, v1, [v3, v4, v5])
        probs_v1_v3_v4_v5_v2 = VE(medical, v1, [v3, v4, v5, v2])
        diffs1 = [abs(probs_v1_v3_v4_v2[i]-probs_v1_v3_v4[i]) < 0.001 for i in range(len(probs_v1_v3_v4_v2))]
        diffs2 = [abs(probs_v1_v3_v4_v5[i]-probs_v1_v3_v4_v5_v2[i]) > 0.0001 for i in range(len(probs_v1_v3_v4_v5))]
        if teach_cs_id == "fongkwan":
            print(v1)
            print(v2)
            print(v3)
            ...
            print(diffs1)
            print(diffs2)
            for i in range(len(probs_v1_v3_v4)):
                print(abs(probs_v1_v3_v4_v2[i]-probs_v1_v3_v4[i]))            
            for i in range(len(probs_v1_v3_v4_v5)):
                print(abs(probs_v1_v3_v4_v5[i]-probs_v1_v3_v4_v5_v2[i]))
            input()
    ...
    v4 = var_lookup[row['V4.2']]
    d4 = clean_value(row['d4'])
    v5 = var_lookup[row['V5.2']]
    ...
    try:
        ...
        probs0 = VE(medical, v0, [])

        v1.set_evidence(d1)
        probs1 = VE(medical, v0, [v1])
        diff = probs1[query_index] - probs0[query_index]
        if diff >= 0:
            current_result["question 2c"] += 1.8
        else:
            current_result["question 2c"] += 1.8
            print("2c: {} {} {}".format(teach_cs_id, probs1[query_index], probs0[query_index]))
        
        if teach_cs_id == "fongkwan":
            print("one ", diff)
            print(current_result["question 2c"])

        v2.set_evidence(d2)
        probs2 = VE(medical, v0, [v1, v2])
        ...
        v4.set_evidence(d4)
        probs4 = VE(medical, v0, [v1, v2, v3, v4])
        ...
        v5.set_evidence(d5)
        probs5 = VE(medical, v0, [v1, v2, v3, v4, v5])
    ...
    v4 = var_lookup[row['V4.3']]
    d4 = clean_value(row['d4.1'])
    v5 = var_lookup[row['V5.3']]
    ...
    try:
        ...
        if diff <= 0:
            ...
            current_result["question 2d"] += 1.8
            print("2d: {} {} {}".format(teach_cs_id, probs1[query_index], probs0[query_index]))
            #input()
    ...
    #print("")
    current_result["total"] = (current_result["question 2a"] + 
