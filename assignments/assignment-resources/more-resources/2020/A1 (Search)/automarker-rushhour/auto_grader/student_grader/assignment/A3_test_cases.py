...
def test_question_6_test_13(modules):
    ...
    #print("FILES ARE: {} {} {}".format(stu_propagators,stu_csp,stu_const))
    ...
    #del courses, classes, buildings, connected_buildings, slots, rest, problem
    #if (stu_propagators): del stu_propagators, stu_csp, stu_const
    del modules
    gc.collect()   
